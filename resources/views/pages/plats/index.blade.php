...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-200 hover:scale-105">
            <div class="h-48 bg-gray-200 overflow-hidden">
                @if($plat->image)
                <img src="{{ asset('storage/images/plats/' . $plat->image) }}" alt="{{ $plat->nom_plat }}" class="w-full h-full object-cover">
                @else
            ...
            <div class="p-4">
                ...
                <div class="flex justify-between items-center mb-3">
                    ...
                    <span class="bg-secondary-100 text-secondary-800 text-xs px-2 py-1 rounded-full">{{ $plat->cuisson }}</span>
                </div>
    ...
    <div class="text-center mt-12">
        ...
        <div class="flex justify-center space-x-4">
            <a href="{{ route('login') }}" class="bg-primary-500 hover:bg-primary-600 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200">
                Se connecter
            </a>
            <a href="{{ route('register') }}" class="bg-secondary-500 hover:bg-secondary-600 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200">
                S'inscrire
            </a>
        </div>
    </div>
