...
@section('content')
    <div class="bg-white rounded-lg shadow-md p-2 mb-2 w-full">
        <!-- Filtres et barre de recherche -->
        @if(auth()->user()->role === 'admin')
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-4 items-end text-accent mb-6">
        @else
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 items-end text-accent mb-6">
        @endif
                <!-- Recherche -->
                <div>
                    ...
                    <input type="text" id="searchInput" placeholder="Nom, prénom, email ou téléphone..."
                        class="w-full border border-accent rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary">
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-accent/20">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-bold text-accent uppercase tracking-wider">Prénom
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-bold text-accent uppercase tracking-wider">Email
                            </th>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-bold text-accent uppercase tracking-wider">Username
                            </th>
                            @if(auth()->user()->role === 'admin')
                                <th class="px-6 py-3 text-left text-xs font-bold text-accent uppercase tracking-wider">Actions
                                </th>
                            @endif
                        </tr>
                    </thead>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div class="flex items-center">
                                    <input type="radio" id="edit_type_etudiant" name="type_client" value="etudiant"
                                        class="h-4 w-4 text-primary focus:ring-transparent border-accent">
